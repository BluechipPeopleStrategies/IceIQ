...
import { characterProportions, resolveCharacterStage } from 'file:///C:/Users/mtsli/IceIQ/src/visuals/characterPresentation.js';
import { CARRY_OFFSET } from 'file:///C:/Users/mtsli/IceIQ/src/one-on-one/simulation.js';
...
export function buildHockeyPlayerRig({ goalie = false, colour = NAVY, number = '', showStick = true, ageBand, stage, finish, view } = {}) {
  ...
  const part = (name, geometry, material, position = [0, 0, 0], rotation = [0, 0, 0], scale = [1, 1, 1]) => {
    ...
    if (!group.__diagnosticParts) group.__diagnosticParts = [];
