  ...
  nodes: {
    entry: {
      ...
      ask: {
        ...
        q: "The attacker is entering with speed. What is the best defensive read?",
        opts: [
          { id: "hold_gap", t: "Hold inside gap and protect the middle", youngT: "Stay in the middle and keep them in front", ok: true, next: "contained" },
          { id: "step_too_early", t: "Step up too early and reach", youngT: "Jump out and reach", no: "Reaching early can open the middle lane.", outcome: "The attacker slips inside.", next: "middleOpen" },
          { id: "back_in", t: "Back straight into the goalie", youngT: "Back into your goalie", no: "Backing in gives the attacker time and space.", outcome: "The attacker keeps the middle available.", next: "middleOpen" },
          { id: "chase_support", t: "Leave the puck carrier to chase A2", youngT: "Chase the other player", no: "The puck carrier is the immediate threat.", outcome: "The middle lane opens.", next: "middleOpen" },
        ],
      },
    },
    contained: {
