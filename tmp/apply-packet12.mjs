...
write(`${folder}/application-receipt.json`,receipt);
write(`${dir}/repairs/claude-packet-12-repairs.json`,receipt);
const independent=JSON.parse(fs.readFileSync(receiptPath));
write(`${dir}/followup/packet-12-final-recheck.json`,{...independent,coverage:independent.questions.map(q=>({...q,contentHash:q.afterHash}))});
