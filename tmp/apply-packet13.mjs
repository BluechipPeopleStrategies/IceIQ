...
write(`${folder}/application-receipt.json`,receipt);
write(`${dir}/repairs/claude-packet-13-repairs.json`,receipt);
const independent=JSON.parse(fs.readFileSync(receiptPath));
write(`${dir}/followup/packet-13-final-recheck.json`,{...independent,coverage:independent.questions.map(q=>({...q,contentHash:q.afterHash}))});
