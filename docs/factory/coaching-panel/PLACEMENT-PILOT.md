...
Remaining: calibrated family-specific rubrics, shaded useful areas in 3D/overhead, first-versus-latest comparison, broader coverage, touch testing and production admission. The five source repair candidates remain separate from the live bank. See placement-coverage.json for measured coverage. Do not describe the whole placement project as completed.
