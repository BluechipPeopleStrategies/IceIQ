...
assert.equal(a.timeBudgetMinutes,600);assert.equal(a.checkpointMinutes,30);
console.log(`Verified ${manifest.files.length} package files; 600-minute assignment.`);
