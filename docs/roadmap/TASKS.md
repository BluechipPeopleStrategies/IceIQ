...
- **2026-07-10** — Added the evidence-led curriculum and research-library planning brief: tiered sources, legal-retention boundary, existing-work crosswalk, age-entry plus competency progression, coach-review admission, and player-transfer validation. Captured in LATER without displacing the active player-facing integration.
