...
- **Evidence-led curriculum and research library.** Build an Obsidian-first, tiered source and evidence library, with original documents retained in Google Drive and only validated product data exported to IceIQ. Include permission-aware capture from Thomas's authenticated coaches' site; extract evidence into an adaptive skater curriculum; crosswalk existing ledger nodes, scenarios, coach decisions, and playtests instead of replacing them. Curriculum admission requires documentary support plus coach review; player testing validates comprehension and transfer. Planning brief: `docs/superpowers/specs/2026-07-10-evidence-led-curriculum-research-library-design.md`.
...
- **2026-07-10** — Added the evidence-led curriculum and research-library planning brief: Obsidian owns research knowledge, Drive owns retained source documents, and IceIQ owns executable data and automation; includes tiered sources, read-only authenticated coach-site capture, existing-work crosswalk, competency progression, coach-review admission, and player-transfer validation. Captured in LATER without displacing the active player-facing integration.
