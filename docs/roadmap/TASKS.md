...
**Last updated:** 2026-07-09 · created; folded next-7 + backlog into one living doc, archived the dated snapshots.
...
- **Cognitive Gym Phase 1 — fix + juice.** Runs beside everything; never blocks. Fix dead age-calibration (division strings never matched seed keys → every kid starts at level 1), put Reaction/Tracking on the shared graded-points scale, add the sound/celebration/feet-not-pixels pass. Spec: `docs/proposals/2026-07-09-cognitive-gym-overhaul-design.md` · Plan: `docs/superpowers/plans/2026-07-09-cognitive-gym-phase1-fix-and-juice.md`. Size: days.
...
- **On-deck game modes** — Rush Hour (time attack, needs the gentle timer), young-age DRAG mini-games (Cover the Pass, Set the Forecheck), mascot + sound pass (mascots = gym Phase 3).
