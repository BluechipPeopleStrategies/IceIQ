    ...
    <Card style={{
      ...
      {expanded && (
        <>
          ...
          {/* Legacy type:"rink" (q.scene) curation has been retired. Any
              review_questions row with that schema shows a note instead of a
              rendered preview. New-schema rink questions (q.rink + type:"mc"
              | drag-target | zone-click | ...) get previewed by the live
              quiz flow; review those by opening the question in-app. */}
          {type === "rink" && c.scene && (
            <div style={{ marginBottom: ".6rem", fontSize: 11, color: C.dimmer, fontStyle: "italic" }}>
              Legacy rink scene (deprecated schema). Preview removed; kill or rewrite this row.
            </div>
          )}
