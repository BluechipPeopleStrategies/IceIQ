...
import companions from './experimental-companions.json';
...
export const EXPERIMENTAL_BANK=composeExperimentalBank(Object.values(files).flat(),[...released(newFiles),...companions],released(additions));
