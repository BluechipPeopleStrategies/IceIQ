...
const TABS=[['read','Read the play'],['learn','Learn the game'],['play','Play'],['coach','Coach Lab'],['brain','Brain Gym']];
export default function PracticeHub({player}) {
  const [tab,setTab]=useState('read'),[coachDraft,setCoachDraft]=useState(null),[draftRevision,setDraftRevision]=useState(0),[error,setError]=useState(''),[library,setLibrary]=useState(false);
