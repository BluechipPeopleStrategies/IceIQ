...
const QB={
  "U7 / Initiation":[
    ...
    {id:"u7q6",cat:"Defense",pos:["F","D"],concept:"Backchecking",d:1,sit:"The other team has the puck and is skating toward your net. What do you do?",opts:["Skate to center ice and wait for a pass","Skate back toward your net to help defend","Stand still and watch the play go past you","Go talk to your coach about a line change"],ok:1,why:"When the other team has the puck and is coming your way, your job is to turn around and get back. This is called backchecking.",tip:"Other team coming? Turn around and skate back hard."},
    {id:"u7q7",cat:"Positioning",pos:["F","D"],concept:"Open ice",d:1,sit:"Five teammates are all bunched in one corner chasing the puck. What's a smart thing to do?",opts:["Join the pile and chase the puck even harder","Find empty ice somewhere else and get open","Skate off the ice and ask for a line change","Stay exactly where you are and call for a pass"],ok:1,why:"Hockey players shouldn't all go to the same spot. Finding open ice gives your team options.",tip:"Everyone's in the corner? Go somewhere else and get open."},
    {id:"u7q8",cat:"Coachability",pos:["F","D"],concept:"Listening",d:1,sit:"Your coach is explaining a drill and you're not sure what to do. What's the best thing?",opts:["Just start skating and just hope you guess the drill right","Listen carefully, then ask what you didn't understand","Do whatever the kid next to you is doing every time","Sit down on the ice until someone comes to help you"],ok:1,why:"Coaches give instructions to help you succeed. Listening well and asking questions is smart, not weak.",tip:"Confused? Listen first, then ask. That's how you get better."},
    ...
    {id:"u7q10",cat:"Compete",pos:["F","D"],concept:"Don't give up",d:1,sit:"You fell down on the ice during a play. What do you do?",opts:["Sit there and wait for a whistle to stop play","Get up as fast as you can and keep playing","Wave your arms for a quick substitution","Watch the rest of the play from the ice"],ok:1,why:"Falling down happens to every player. Getting up fast and staying in the play is compete. The game doesn't stop — neither do you.",tip:"Fell down? Get up fast. Keep going."},
    ...
    {id:"u7q12",cat:"Teamwork",pos:["F","D"],concept:"Celebrate together",d:1,sit:"Your teammate scores a goal. What should you do?",opts:["Do nothing — you weren't the one who scored","Skate toward them and celebrate together","Skate off the ice for a quick line change","Stand by yourself and wait at center ice"],ok:1,why:"Hockey is a team sport. When a teammate scores, everyone celebrates — you win together. Learning to celebrate your teammates' goals is part of being a good teammate.",tip:"Teammate scored? Celebrate with them. You're a team."},
    ...
    {id:"u7q18",cat:"Compete",pos:["F","D"],concept:"Board battle",d:2,sit:"You and an opponent both reach a loose puck along the boards at the same time. What do you do?",opts:["Stop skating and let them have the whole puck this time","Use your body to shield the puck and fight to keep it","Skate away quickly and hope a teammate gets to it","Fall down on the ice and hope the ref stops it fast"],ok:1,why:"Puck battles are won by the player who competes harder. Using your body to create a wall between the opponent and the puck is a real skill.",tip:"Puck battle: get your body between the opponent and the puck."},
    ...
    {id:"u7q20",cat:"Scoring",pos:["F","D"],concept:"Good angle",d:2,sit:"You have the puck right beside the net — almost behind it. The angle is really bad. You can barely see the net. What should you do?",opts:["Shoot from right there anyway and hope it goes through the goalie","Skate to in front of the net for a better angle before shooting","Pass the puck all the way back to a teammate at center ice","Stop skating and wait for the goalie to move out of the way"],ok:1,why:"Shooting from behind the net or from a bad angle gives the goalie an easy save. Taking an extra second to find a better angle — like cutting to the front — makes the shot much more dangerous.",tip:"Bad angle? Move to a better one. Then shoot."},
    ...
    {id:"u7q26",cat:"Teamwork",pos:["F","D"],concept:"Be a good sport",d:2,sit:"The other team scores a goal against you. What do you do?",opts:["Argue with the referee","Say something mean to the other team","Skate back to your position and get ready for the next play","Sit down on the ice"],ok:2,why:"Goals happen in every game — even the best teams give them up. The response to a goal against is to regroup and get ready to play. Good sportsmanship means handling both winning and losing the right way.",tip:"Goal against? Head up. Get back to your position. The game's not over."},
    {id:"u7q27",cat:"Scoring",pos:["F","D"],concept:"Follow your shot",d:2,sit:"You shoot the puck at the net. The goalie doesn't quite catch it — the puck bounces off them. What should you do?",opts:["Skate away — you already took your one shot","Chase the rebound and try to shoot again","Celebrate even though it didn't go in","Just wait for the referee to blow it dead"],ok:1,why:"Rebounds from your own shot are one of the easiest scoring chances in hockey. Chasing your shot to the net means you might get a second chance.",tip:"Follow your shot. Rebounds are your friend."},
    ...
    {id:"u7q34",cat:"Game Awareness",pos:["F","D"],concept:"Penalty",d:2,sit:"A player on your team does something against the rules and gets a penalty. What happens next?",opts:["Your team gets to add one extra player out on the ice for a while","Your team has to play with one less player for a period of time","Nothing changes at all — the game keeps going just like before","The other team also has to lose one of their players for a while"],ok:1,why:"When your team takes a penalty, you have to play shorthanded — with fewer players. This is why avoiding penalties is important. The other team has an advantage until the penalty is over.",tip:"Your team has a penalty? You're playing with fewer players. Everyone has to work harder."},
    {id:"u7q35",cat:"Defense",pos:["F","D"],concept:"Shot block",d:2,sit:"A player from the other team is about to shoot the puck at your net. You're between them and the net. What could you try to do?",opts:["Move out of the way so the puck doesn't hit you or any of your teammates","Get in the shooting lane and try to block the shot with your body or stick","Skate to your bench and let your goalie handle the shot all on their own","Turn around and look away fast so the puck can't hit you right in your face mask"],ok:1,why:"Blocking shots is a way every player can help their team. Getting in the lane between the shooter and your net might deflect or block the shot.",tip:"Player about to shoot? Try to get in the lane and block it."},
    {id:"u7q36",cat:"Positioning",pos:["F","D"],concept:"Rush attack lanes",d:3,sit:"Your team is rushing toward the other team's net — you have more players than the other team right now. Where should you be on the ice to help most?",opts:["Skate as close to the puck carrier as you possibly can every time","Spread across the ice so the defenders have to cover more space","Skate behind the puck carrier the whole way and follow them","Stop skating and watch the puck carrier handle it by themselves"],ok:1,why:"Spreading out on a rush forces defenders to cover more space, opening up passing lanes and shooting opportunities.",tip:"Rush attack? Spread across the ice. Give the defenders more to think about."},
    {id:"u7q37",cat:"Teamwork",pos:["F","D"],concept:"Call for the puck",d:3,sit:"You're in a great open spot in the offensive zone with no defenders near you. Your teammate has the puck but hasn't seen you. What do you do?",opts:["Stay quiet — yelling for the puck is rude to the other team's players","Call your teammate's name or yell 'here!' to let them know you're open","Skate toward them quickly to get the puck yourself and try to score it","Wait patiently and hope they turn around and spot you all by themselves"],ok:1,why:"Letting your teammate know you're open is the right play. A loud 'here!' gives them a target and might lead directly to a scoring chance.",tip:"Open and your teammate can't see you? Call for the puck. Let them know."},
    {id:"u7q38",cat:"Scoring",pos:["F","D"],concept:"Rebound position",d:3,sit:"Your teammate is shooting the puck at the net from the blue line. You're the nearest forward. What should you do?",opts:["Stay where you are — the shot might just go wide of the net","Skate hard toward the net to get in position for a rebound","Skate away from the net in case the shot ends up going wide","Skate to the corner and wait for the puck to come out there"],ok:1,why:"Shots from the blue line often produce rebounds. Getting to the front of the net before the shot arrives puts you in position to score on the rebound.",tip:"Teammate shooting from far away? Crash the net. Be ready for the rebound."},
    ...
    {id:"u7q40",cat:"Compete",pos:["F","D"],concept:"Going to the front of the net",d:3,sit:"Skating to the front of the other team's net when you don't have the puck can be scary because defenders are there. Why is it worth doing anyway?",opts:["It isn't worth doing — always stay far away from defenders so you don't have to battle anyone during play or get pushed around in front","Because standing there creates scoring chances for your team — rebounds, screens, tips. The best chances come from the front of the net.","Because referees give you a whole bunch of extra points for being brave and skating into a really tough spot that nobody else wants to go to","Because it tires out the goalie faster when you stand in front of them for a really long time during every single play of the game"],ok:1,why:"The front of the net is the most dangerous area in hockey. Going there creates screens, rebound chances, and tip opportunities — even though defenders are there. Competing in tough spots is how goals are scored.",tip:"Front of the net is hard. Go there anyway. That's where goals come from."},
    {id:"u7q41",cat:"Positioning",pos:["F","D"],concept:"Don't follow the crowd",d:3,sit:"The puck is in the offensive zone corner. All five of your teammates are chasing it in the corner. The entire front of the net and the blue line are empty. What should you do?",opts:["Join the crowd — the more teammates fighting for the puck in one spot the better for your team","Pick one of the empty spots — net front or blue line — and get there. Give your team an option.","Skate to the bench right away and take a quick rest while your teammates fight for the puck for you","Watch and wait for one of your teammates to pass the puck to you right there in the corner they are in"],ok:1,why:"When everyone goes to the same spot, all the other spots open up. Finding the empty space — net front, blue line — gives your team a passing option and makes the defense split.",tip:"Everyone in the corner? Pick the empty spot. You're more useful there."},
    {id:"u7q42",cat:"Coachability",pos:["F","D"],concept:"Feedback",d:3,sit:"After a drill, your coach tells you something you did wrong and shows you how to do it better. How should you react?",opts:["Argue — you're sure you did it right the first time","Ignore it — just do it your own way next time","Say thank you and try it the way they showed you","Feel really bad and not even try the drill anymore"],ok:1,why:"Feedback from coaches is how you get better. A coach who corrects you is investing in you. Listening, saying thank you, and trying the correction is exactly what the best players do.",tip:"Coach gave you feedback? Say thanks and try it their way. That's how you improve."},
    {id:"u7q43",cat:"Teamwork",pos:["F","D"],concept:"Win together, lose together",d:3,sit:"Your team loses the game. A teammate is feeling really sad. What do you say or do?",opts:["Tell them loudly that it was their fault your team lost the whole game today","Ignore them and just walk away — you're feeling really bad about the loss too","Say 'good game' and encourage them — you'll work hard and get better together","Blame the referee loudly for every bad call they made against your team this game"],ok:1,why:"Losing is part of sports. Being a good teammate means supporting each other even when things go wrong. Encouraging a sad teammate is one of the most important things you can do.",tip:"Team lost and a teammate is sad? Encourage them. You're in it together."},
    ...
    {id:"u7q45",cat:"Defense",pos:["F","D"],concept:"Protect the front",d:3,sit:"An attacker is trying to stand right in front of your goalie. Your goalie can't see the puck with the attacker there. What should you try to do?",opts:["Ignore the attacker — the goalie can figure out where the puck is","Move the attacker out of the crease area so your goalie can see","Go get the puck in the corner and leave the attacker alone for now","Stand beside the attacker and watch them block the goalie's view"],ok:1,why:"An attacker screening your goalie is a real problem. Moving them out of the crease area is the defender's job so the goalie can see the puck coming.",tip:"Attacker in front of your goalie? Move them out. Your goalie needs to see."},
    {id:"u7q46",cat:"Game Awareness",pos:["F","D"],concept:"Faceoffs",d:3,sit:"There's a faceoff near your team's net. You're not the one taking the faceoff. Where should you be standing?",opts:["Wherever you feel like standing — it doesn't really matter where you are for any faceoff at all","In your assigned faceoff position — usually covering a player or an area near the faceoff dot","Standing right on top of the faceoff dot so you can grab the puck before anyone else on the ice","All the way back at center ice so you can be ready if the puck ever comes out to you later"],ok:1,why:"Faceoffs are set plays. Everyone has a position — you're not just watching the center take the draw. Being in position before the puck drops means your team is ready to win the faceoff and execute.",tip:"About to have a faceoff? Get to your position before the puck drops. Be ready."},
    ...
    {id:"u7q76",cat:"Coachability",pos:["F","D"],concept:"Try it a new way",d:3,sit:"You've always held your stick one way. Your coach tells you there's a better way that will help you skate faster with the puck. It feels weird at first. What do you do?",opts:["Keep doing it the same old way — it feels right to you and your coach is pretty much wrong here about this","Try the new way, even though it feels weird. New things feel weird at first — that's part of learning.","Do half of it the new way that the coach is telling you and then half of it the old way you always did","Ask your parents about it all after practice and see if they really think the coach is right or wrong"],ok:1,why:"Almost every skill improvement feels awkward at first. The feeling of 'weird' is your brain and body adjusting to something new. Sticking with the new way through the awkward phase is how you improve.",tip:"New way feels weird? Keep trying it. Weird is what improvement feels like at first."},
    {id:"u7q77",cat:"Teamwork",pos:["F","D"],concept:"Encourage on the bench",d:3,sit:"A teammate comes off the ice after making a mistake and they look down. Nobody has said anything to them. What do you do?",opts:["Just say nothing — they already know they made a mistake on the ice","Say something encouraging — 'You've got it next time' or 'good effort'","Tell them exactly what they did wrong and how they should not do it again","Ignore them completely and wait for the coach to come talk with them"],ok:1,why:"A teammate who feels supported after a mistake is more likely to bounce back quickly and play well. One encouraging word from a teammate can make a real difference.",tip:"Teammate came off after a mistake? Encourage them. That's what good teammates do."},
    {id:"u7q78",cat:"Scoring",pos:["F","D"],concept:"Shoot on the move",d:3,sit:"You're skating with the puck toward the net at full speed. A defender is chasing you from behind. Should you slow down to take a better shot?",opts:["Yes — slow down and aim really carefully so you can pick a spot in the corner of the net to hit","No — shoot while moving at full speed. A moving shooter is harder for the goalie to track.","Stop completely first and then shoot the puck when you are standing still and you can aim it well","Pass it to one of your teammates who is wide open on the other side of the net instead of shooting"],ok:1,why:"Shooting while moving at full speed is harder for a goalie to track than a stationary shot. Slowing down also lets the defender catch up. Shoot while moving.",tip:"Full speed toward the net? Shoot while moving. Don't slow down."},
    ...
    {id:"u7q90",cat:"Compete",pos:["F","D"],concept:"Pre-game warmup compete",d:3,sit:"During warmups before the game, your team is doing skating drills. Some players are coasting. What do you do?",opts:["Coast through it too — it's just warmups and doesn't count","Go hard. How you warm up sets the tone for how you play.","Warm up halfway through and then just watch the other team","Only go hard on the last drill of the warmup before the game"],ok:1,why:"Warming up hard prepares your body, sharpens your mind, and signals to your teammates that you're ready to compete. Players who coast in warmups often coast in the game.",tip:"Warmup drills? Go hard. Your first rep sets the tone for everything after."},
  ...
  ,
    ...
    {id:"u7g4",cat:"Goalie",concept:"Rebounds",d:1,pos:["G"],sit:"You stop a shot but the puck bounces out in front of your net. What should you do?",opts:["Stand still and just wait for the other team to take another shot on goal","Try to cover the puck or push it to the corner so your team can get it","Skate out of the crease and try to pass the puck up to one of your teammates","Skate to the bench and leave the net wide open for a new goalie to come in"],ok:1,why:"A rebound right in front of your net is dangerous — the other team can shoot again immediately. Try to cover it with your glove or paddle it to the corner where your team can get it.",tip:"Stop it once, then smother it or push it away. Don't let the rebound sit in front."},
    ...
    {id:"u7g6",cat:"Goalie",concept:"Crease awareness",d:1,pos:["G"],sit:"A player from the other team is standing right in front of your net blocking your view. What do you do?",opts:["Ignore them completely and just trust that your teammates will come push them out of the way","Try to see around them — move side to side a little to get a better view of the puck","Skate into them and try to push them out of the front of the crease all by yourself","Sit down on the ice so you can try to see the puck underneath the player's legs and skates"],ok:1,why:"Goalies can move slightly side to side to peek around a screener. Your teammates should also be pushing that player out, but you can help yourself by moving to find the puck.",tip:"Screener in front? Move to find the puck. Don't just stand still."},
