...
function AuthScreen({ onAuthenticated, onDemo }) {
  ...
  return (
    <div style={{minHeight:"100vh",position:"relative",background:"#0d1e3a",display:"flex",flexDirection:"column",justifyContent:"center",padding:"2rem 1.5rem",fontFamily:FONT.body,color:C.white,overflow:"hidden"}}>
      {/* Ice rink background */}
      <RinkBackground/>
      {/* Light vignette — keeps edges softly dark without hiding the rink */}
      <div style={{position:"absolute",inset:0,background:"radial-gradient(ellipse at center, rgba(8,14,26,0) 0%, rgba(8,14,26,0.15) 60%, rgba(8,14,26,0.45) 100%)",pointerEvents:"none"}}/>
