...
const DRILLS = [
  ...
  },
  {
    ...
    why: "Knowing where your options are without staring at the puck is how you find the open player, break out cleanly, and see the check before it arrives.",
  ...
  },
  {
    ...
    why: "On the ice the play never holds still. Picking a teammate's number off a jersey as they fly up the wing, or clocking a number on the rush, is how you find the open player and put the puck on the right tape instead of guessing. Training your eyes to lock onto a small, fast-moving target is the same skill that helps you track the puck and read bodies at full speed.",
