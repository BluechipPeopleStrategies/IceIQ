...
const laterRows=[...(later?.results|| (later?.questionId?[later]:[])),...['original-user-feedback-recheck.json','related-board-recheck.json','calibration-final-recheck.json','packets-02-06-final-recheck.json','packets-07-09-final-recheck.json','packets-10-11-final-recheck.json','packet-12-final-recheck.json','packet-13-final-recheck.json','packet-14-final-recheck.json','packets-15-16-final-recheck.json','packet-17-final-recheck.json','packet-18-final-recheck.json'].flatMap(file=>fs.existsSync(`${dir}/followup/${file}`)?read(`followup/${file}`).coverage||[]:[])].filter(r=>originalIds.has(r.questionId));
