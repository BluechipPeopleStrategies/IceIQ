...
for(const file of ['original-user-feedback-recheck.json','related-board-recheck.json','calibration-final-recheck.json','packets-02-06-final-recheck.json','packets-07-09-final-recheck.json','packets-10-11-final-recheck.json','packet-12-final-recheck.json']){
